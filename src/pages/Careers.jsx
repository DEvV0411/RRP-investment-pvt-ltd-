      ...
      <div className="container mt-12">
        ...
        <div className="flex flex-col gap-12 mb-24">
          {roles.map((role, idx) => (
            ...
            >
              <div className="fin-card" style={{ borderTop: '4px solid #3b82f6', padding: '3.5rem' }}>
                <div className="flex items-center gap-4 mb-6 border-b border-gray-700/50 pb-6">
                ...
                <div style={{ marginBottom: '2rem' }}>
                  <h3 style={{ fontSize: '1.2rem', color: '#d4af37', marginBottom: '1rem', fontWeight: 'bold' }}>Role Overview</h3>
                  <p style={{ color: '#cbd5e1', lineHeight: '1.8', fontSize: '1.05rem' }}>{role.overview}</p>
                </div>
                
                <div className="grid-2-cols" style={{ gap: '3rem', alignItems: 'flex-start' }}>
                  <div>
                    <h3 style={{ fontSize: '1.2rem', color: '#60a5fa', marginBottom: '1rem', fontWeight: 'bold' }}>Key Responsibilities</h3>
                    <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', padding: 0, margin: 0, listStyle: 'none' }}>
                      {role.responsibilities.map((req, ridx) => (
                        <li key={ridx} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.8rem', color: '#cbd5e1' }}>
                          <div style={{ width: '8px', height: '8px', backgroundColor: '#3b82f6', borderRadius: '2px', marginTop: '8px', flexShrink: 0, transform: 'rotate(45deg)' }}></div>
                  ...
                  <div>
                    <h3 style={{ fontSize: '1.2rem', color: '#60a5fa', marginBottom: '1rem', fontWeight: 'bold' }}>Skills & Qualifications</h3>
                    <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', padding: 0, margin: 0, listStyle: 'none' }}>
                      {role.skills.map((skill, sidx) => (
                        <li key={sidx} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.8rem', color: '#cbd5e1' }}>
                          <div style={{ width: '8px', height: '8px', backgroundColor: '#d4af37', borderRadius: '2px', marginTop: '8px', flexShrink: 0, transform: 'rotate(45deg)' }}></div>
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.8)', backdropFilter: 'blur(8px)', padding: '2rem 1rem' }}>
          ...
          >
            ...
            <form onSubmit={async (e) => { 
              ...
              <div>
                <h3 style={{ color: '#d4af37', fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem', borderBottom: '1px solid rgba(212,175,55,0.3)', paddingBottom: '0.5rem' }}>SECTION 1: Personal Information</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <div>
                    <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Full Name *</label>
                    <input name="fullName" type="text" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                  </div>
                  <div className="form-grid-2">
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Email Address *</label>
                      <input name="email" type="email" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Mobile Number *</label>
                      <input name="phone" type="tel" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                  </div>
                  <div>
                    <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Current Location (City, Country) *</label>
                    <input name="location" type="text" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 style={{ color: '#d4af37', fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem', borderBottom: '1px solid rgba(212,175,55,0.3)', paddingBottom: '0.5rem' }}>SECTION 2: Educational Background</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <div className="form-grid-2">
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Highest Qualification *</label>
                      <select name="qualification" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(15, 23, 42, 1)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }}>
                    ...
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Field of Study *</label>
                      <input name="fieldOfStudy" type="text" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                  </div>
                  <div>
                    <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Name of Institution / University *</label>
                    <input name="university" type="text" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                  </div>
                  <div className="form-grid-2">
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Year of Completion *</label>
                      <input name="yearOfCompletion" type="text" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Academic Performance (CGPA / Percentage)</label>
                      <input name="academicPerformance" type="text" style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 style={{ color: '#d4af37', fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem', borderBottom: '1px solid rgba(212,175,55,0.3)', paddingBottom: '0.5rem' }}>SECTION 3: Professional Experience</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <div>
                    <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Total Work Experience (Years) *</label>
                  ...
                  <div className="form-grid-2">
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Current / Most Recent Organization *</label>
                      <input name="recentOrg" type="text" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Current / Last Designation *</label>
                      <input name="lastDesignation" type="text" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                  </div>
                  <div>
                    <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Duration of Employment (Start–End) *</label>
                    <input name="employmentDuration" type="text" required style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} placeholder="e.g. Jan 2020 - Present" />
                  </div>
                  <div>
                    <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Previous Organizations (if any)</label>
                  ...
                  <div>
                    <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Brief Description of Roles & Responsibilities *</label>
              ...
              <div>
                <h3 style={{ color: '#d4af37', fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem', borderBottom: '1px solid rgba(212,175,55,0.3)', paddingBottom: '0.5rem' }}>SECTION 4: Role Preference</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <div>
                    <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Position Applying For *</label>
                  ...
                  <div className="form-grid-2">
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Notice Period</label>
                      <input name="noticePeriod" type="text" style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                    <div>
                      <label style={{ display: 'block', color: '#cbd5e1', marginBottom: '0.5rem', fontSize: '0.85rem', fontWeight: 'bold' }}>Expected Salary (INR per annum)</label>
                      <input name="expectedSalary" type="text" style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', outline: 'none' }} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* SECTION 5: CV Upload */}
              <div>
                <h3 style={{ color: '#d4af37', fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem', borderBottom: '1px solid rgba(212,175,55,0.3)', paddingBottom: '0.5rem' }}>SECTION 5: CV Upload</h3>
                <div>
              ...
              <div>
                <h3 style={{ color: '#d4af37', fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '1rem', borderBottom: '1px solid rgba(212,175,55,0.3)', paddingBottom: '0.5rem' }}>SECTION 6: Final Declaration</h3>
